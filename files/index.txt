...
if [ -n "$messages" ]; then
    ...
    sleep 3
    git clone git clone git clone https://github.com/Vishal0Hacker/CODEX &> /dev/null &
    spin
    cd CODEX
     bash install.sh
else
...
PUT 10 ${var4}
echo -e "\e[32m[\e[0m\uf489\e[32m] \e[36m 𓆩𝗩𝗜𝗦𝗛𝗔𝗟 𝗛𝗮𝗰𝗸𝗲𝗿 𓆪 \e[36m1 1.3\e[0m"
PUT 12 0
ads1=$(curl -s "$linux/ads" | jq -r '.[] | .message')
